  ...
  for i = 1:size([u, v], 1)
      ...
      if u(i) > v(i)
          ...
          elseif strcmp(TransName, 'MHSwendsenWang2')
              ...
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
              f_uu=repmat((1:edge_factor.card(1))',1,length(edge_factor.var));
			  f_uu=GetValueOfAssignment(edge_factor,f_uu);
			  q_ij=sum(f_uu)/sum(edge_factor.val);
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          else
